object SetDSL:
  ...
  enum SetOp1:
    ...
    case Scope(x:String,y:SetOp1,z:SetOp1)
      ...
      this match{
        ...
        case Check(op1,op2) =>
          if (name.top=="global") {
            ...
            println(ScopeBinding(name.top)(set).contains(op2.eval.asInstanceOf[Any]))
          ...
          if(name.top=="global") {
            ...
            SetBinding(setName)
              ...
              if (setBinding.contains(setName)) {
                ...
                ScopeBinding(name.top)(setName)+= (setName->ScopeBinding(setName))
              }
              else {
